                    ...
                    <div className="row">
                        <div className="col-xl-6 col-lg-8">
                            <div className="banner-two__content">
                                <h3 className="banner-two__title">We Deliver the <br />
                                    <span>Software</span> you <br /> Need.</h3>
                                <p className="banner-two__text">We are committed to providing our customers
                                    with <br /> exceptional service while offering our employees the <br /> best training.
                                </p>
                                <a href="#" className="banner-two__btn thm-btn "><span>Get Started</span></a>
                            </div>
                        </div>
                    </div>
                </div>
